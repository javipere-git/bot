...
def main() -> None:
    ...
    print(f"      cambios en los ultimos 30s: {obs.cambios('ZZZ', 30)}")
    ...
    cfg = EngineConfig(
        ...
        max_cambios_bid_ask=5, ventana_cambios_s=30,
    )
